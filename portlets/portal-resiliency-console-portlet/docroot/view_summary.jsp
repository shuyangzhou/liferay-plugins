...
<%
List<SPIProvider> spiProviderList = MPIHelperUtil.getSPIProviders();
...
<%
	List<SPI> spiList = MPIHelperUtil.getSPIs(spiProvider.getName());
...
%>
			...
			<portlet:actionURL var="destroySPIURL">
				...
				<portlet:param name="spiId" value="<%= spi.getSPIConfiguration().getSPIId() %>" />
			</portlet:actionURL>
